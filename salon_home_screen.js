...
import salon_profile from './salon_profile';
...
class salon_home_screen extends React.Component {
  ...
  render() {
    ...
    if (this.state.selectedbtn == "1") {
      AppComponent = My_salon
   } 

    // if (this.state.selectedbtn == "2") {
    //    AppComponent = add_staff
    // } 
        ...
        <Footer>
          <FooterTab style={styles.footer}>
            ...
            {/* <Button vertical style={(this.state.selectedbtn== "2")?styles.btnactive:styles.btnsegment} onPress={() => this.setState({ selectedbtn: "2" })}>
              <Icon style={(this.state.selectedbtn== "2")?styles.activeicone:styles.inactiveicone} name="account-group" type="MaterialCommunityIcons" />
...
export default salon_home_screen;