...
class LoginScreen extends React.Component {
  ...
  login=()=>{
    ...
    let uploaddata = new FormData();
           ...
           let api = Connection+'salon_App.php?action=login_user_1';
    ...
    fetch(api, {
        ...
        .then((response) => {
          console.log("responseaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",response)
          ...
          console.log("role",role)
            ...
            else if(response.response=='add_new'){
              AsyncStorage.setItem('customer', JSON.stringify(response.response));
              this.props.navigation.navigate("add_Salon")
            } 
            
            else {
              AsyncStorage.setItem('customer', JSON.stringify(response.response));
              this.props.navigation.navigate("salon_home_screen")
            } 
...
<TouchableOpacity  onPress={() =>  Actions.salon_home_screen()} style={{width: wp('90%'), marginTop: 30, height: hp('7%'),   alignSelf: 'center', borderRadius: 8, backgroundColor: '#ee2b7a', alignItems: 'center', justifyContent: 'center'}}   >
...
<TouchableOpacity onPress={()=>Actions.add_Salon()} style={{width: wp('90%'), marginTop: 10, height: hp('7%'),   alignSelf: 'center', borderRadius: 8,  alignItems: 'center', justifyContent: 'center'}}   >
